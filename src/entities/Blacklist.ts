...
export class Blacklist {
    ...
    /* ACCESS TOKEN */
    public static async addAccessToken(jti: string, reason: string, expiresIn: number) {
        return await TokenStore.addToken(Blacklist.ACCESS_TOKEN_PREFIX, jti, reason, expiresIn); 
    }
